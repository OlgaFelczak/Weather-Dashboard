...
$("#search-button").click(async (e) => {
  ...
  saveToLocalStorageAndRenderButton(searchInputValue, transformedWeathers);
  renderForecast(searchInputValue, transformedWeathers);
});

function saveToLocalStorageAndRenderButton(city, forecast) {
  localStorage.setItem(city, forecast);
